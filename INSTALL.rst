...
``src/vng/conf/local.py``. You can base this file on the
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       $ docker-compose up -d
       Starting vng_db_1 ... done
       Starting vng_web_1 ... done
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       $ docker exec -it vng_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       $ docker exec -it vng_web_1 /app/src/manage.py loaddata admin_index groups
...
.. _Github: https://github.com/maykinmedia/vng/
...
environment variables. See ``src/vng/conf/docker.py`` for
all settings.
...
.. code-block:: bash
    ...
    $ docker run \
        -p 8000:8000 \
        -e DJANGO_SETTINGS_MODULE=vng.conf.docker \
        -e DATABASE_USERNAME=... \
        -e DATABASE_PASSWORD=... \
        -e DATABASE_HOST=... \
        --name vng \
    ...
    $ docker exec -it vng /app/src/manage.py createsuperuser
