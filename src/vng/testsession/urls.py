...
urlpatterns = [
    ...
    url('(?P<session_id>[0-9]+)/test-report-pdf/(?P<pk>[0-9]+)', views.SessionTestReportPDF.as_view(), name='session-test_report-pdf'),
    url('(?P<session_id>[0-9]+)/test-report/(?P<pk>[0-9]+)', views.SessionTestReport.as_view(), name='session-test_report'),
